...
describe('Mocha smoke test', () => {
    ...
    it('should handle promises in waitUntil callback funciton', () => {
        ...
        assert.deepEqual(results, ['https://www.volvocars.com/intl/v/car-safety/a-million-more', 'https://www.volvocars.com/intl/v/car-safety/a-million-more'])
    })
    ...
    describe('overwrite native commands', () => {
        ...
        it('should respect promises - browser', () => {
            ...
            assert.equal(browser.getUrl('/foobar'), 'https://www.volvocars.com/intl/v/car-safety/a-million-more')
        })
